...
--
-- Host: localhost
-- Generation Time: Sep 21, 2017 at 09:59 AM
...
CREATE TABLE `maintenance` (
  ...
  `hydraulic oil` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `wheel rotation` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tire pressure` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `spark plug wire` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('m170921_062035_create_maintenance_table', 1505977109);
...
(2, 'andrii', 'kaa89pl@gmail.com', '$2y$10$HwU0PaTgNPsxPanrq35I0uCYMCbtUMZFlcyoAjOXeqgXD4oWgx//C', 'FSPSDKWB5YJtzFwarOsPdm_BllJOB157', 1505821422, NULL, NULL, '127.0.0.1', 1505821396, 1505821396, 0, 1505917115, NULL),
(5, 'test', 'testyii2@ukr.net', '$2y$10$sIamjJu9vPrkTXMXhSbT8OH5ia2OgqI4yPCHvrwX/vqjiseYNmRAu', 'dsMef6VQa_hBhxvtXs5Fp7w4gp-T0v5s', 1505890547, NULL, NULL, '127.0.0.1', 1505890518, 1505890518, 0, 1505916265, NULL);
