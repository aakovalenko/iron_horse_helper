...
class m170928_134044_create_tag_tables extends Migration
{
    public function Up()
    {
        ...
        $this->addForeignKey('fk-product_tag-product', '{{%product_tag}}',
            'product_id', '{{%product}}', 'id', 'CASCADE', 'RESTRICT');
        $this->addForeignKey('fk-product_tag-tag', '{{%product_tag}}', 'tag_id', '{{%tag}}',
        'id','CASCADE', 'RESTRICT');
    ...
    public function down()
    {
        echo "m170928_134044_create_tag_tables cannot be reverted.\n";
