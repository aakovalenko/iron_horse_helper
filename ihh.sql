...
--
-- Host: localhost
-- Generation Time: Sep 19, 2017 at 05:37 PM
...
('user', 1, 'User', NULL, NULL, 1505812144, 1505812144);
...
INSERT INTO `iron_horse` (`id`, `user_id`, `brand`, `model`, `year`, `engine`, `mileage`, `color`, `created_at`, `updated_at`) VALUES
(1, 2, 'subaru', 'wrx', 2015, 2600, 13900, 434343, 1505831011, NULL),
(2, 2, 'mitsubishi', 'lancer x', 2016, 2000, 13900, 434343, 1505831405, 1505831419);
...
('m170919_122626_create_iron_horse_table', 1505830072);
...
(2, 'andrii', 'kaa89pl@gmail.com', '$2y$10$HwU0PaTgNPsxPanrq35I0uCYMCbtUMZFlcyoAjOXeqgXD4oWgx//C', 'FSPSDKWB5YJtzFwarOsPdm_BllJOB157', 1505821422, NULL, NULL, '127.0.0.1', 1505821396, 1505821396, 0, 1505829633, NULL);
